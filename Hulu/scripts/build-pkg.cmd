...
npm i -g nativefier && nativefier --verbose -n %NAME% %WEBSITE_URL% --tray --enable-es3-apis --widevine --single-instance --background-color %BACKGROUND_COLOR% --internal-urls %INTERNAL_URLS% --user-agent %USER_AGENT% --icon %ICON_PATH% %BASE_FOLDER% && python3 -m castlabs_evs.vmp sign-pkg --persistent %SIGN_PATH%