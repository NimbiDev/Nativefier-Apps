...
nativefier --verbose -n %NAME% %WEBSITE% --tray --enable-es3-apis --background-color %BG_COLOR% --internal-urls %INTERNAL_URLS% --user-agent %USER_AGENT% && copy %UPGRADE_FILE% %UPGRADE_PATH%