@echo off
Set app_title=Prime Video
Set app_name="prime-video"
...
Set debug_path="..\..\logs\%app_name%\%app_title%_%my_date%_%my_time%.log"Set app_path="..\..\apps\%app_name%\%app_name%-win32-x64"
